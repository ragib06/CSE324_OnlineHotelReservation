        ...
        <div id="content">
            <div id="content_left">
                <div class="content_left_section">
                    ...
                    <form:form name="addadvertiseform" action="addadvertise.htl" enctype="multipart/form-data" commandName="addAdvertise" method="post">
                        ...
                        <div class="form_row">
                                ...
                                <input name="advertiseImageFile" type="file"/>
                        </div>
                        <div class="form_row" >
                            <input class="submitbutton" type="submit" value="Request Advertisement"/>
                        </div>
                    </form:form>

                    <script language="JavaScript" type="text/javascript">
                        //You should create the validator only after the definition of the HTML form
                        var frmvalidator  = new Validator("addadvertiseform");
