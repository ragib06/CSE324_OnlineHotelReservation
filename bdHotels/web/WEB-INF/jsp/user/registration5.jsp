        ...
        <div id="content">
            <div id="content_left">
                ...
                <div class="content_left_section">
                    ...
                    <form:form method="post" action="registrationStep5.htm" commandName="register">
                        <table border="0">
                            <tbody>
                                <tr>
                                    <td><input class="submitbutton2" type="submit" value="submit"/></td>
                                        </form:form>
                                     <form:form method="post" action="registrationStep4Back.htm" commandName="register">
