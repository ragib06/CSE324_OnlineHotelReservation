        ...
        <div id="content">
            <div id="content_left">
                <div class="content_left_section">
                    <div class="content_title_01">New Hotel Information</div>
                    <font size="3">
                        A new Hotel named <h2>${hotelinfo.name}!</h2> is added to the Database !!<br>
                        here is the info:<br><br>
                        Username: <font color="red"> ${hotelinfo.username}</font><br>
                        Password: <font color="red">${hotelinfo.password}</font><br>
                        IP Address: <font color="red"> ${hotelinfo.ipaddress}</font><br>
                        Port: <font color="red">${hotelinfo.port}</font><br>
                        Contextpath: <font color="red"> ${hotelinfo.contextpath}</font><br>
                    </font>
                </div>
                <!-- end of welcome -->
